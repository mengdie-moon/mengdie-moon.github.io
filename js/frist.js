...
document.addEventListener('DOMContentLoaded', function() {
    ...
    button.addEventListener('click', function() {
        Swal.fire({
            ...
            html: `
                <p>对<span>检查官</span>的话: 打开控制台的有<span>惊喜！</span></p>
                <hr>
                <p>例外本站啥用没有呜呜 没有技术文章~但是<span style="color: rgb(207, 190, 166);">正在努力更新了(征集文章 投稿可＋我联系方式)</span>例外<span>感谢开源社区-评论功能由Valine提供支持！</span></p>
                <p>本站源码尽在<span style="color: rgb(207, 190, 166);">'源码下载'</span>一栏里 还有各种我以前写过的源码！</p>
                <p>需要技术文章请切换到<span>csdnSearch/生活随笔</span>后续会支持<span>githubSearch</span>,<span>博客圆Search</span></p>
                <p>啊吧啊吧 <span style="color: rgb(207, 190, 166);">变化好大哟~我也成长啦 嘻嘻✌</span></p>
                <p>❗QQ: 597569159--群 希望有大佬送上门指点我[doge]❗</p>
                <p>最近更新时间: 2024-9-28 国庆快乐！！</p>
            `,
