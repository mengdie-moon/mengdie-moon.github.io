...
// // 每秒检查一次
// var lastOuterWidth = window.outerWidth; // 记录上一次的窗口外宽度
// var lastOuterHeight = window.outerHeight; // 记录上一次的窗口外高度
// var check = setInterval(function() {
//     // 检查窗口大小是否发生变化，并且变化量大于阈值
//     if ((window.outerWidth - window.innerWidth > threshold || 
//          window.outerHeight - window.innerHeight > threshold) &&
//         // 确保窗口大小变化是由于打开开发者工具而不是缩放
//         (lastOuterWidth !== window.outerWidth || lastOuterHeight !== window.outerHeight)) {
//         // 如果打开控制台，则刷新页面
//         alert("刷新了亿下~");
