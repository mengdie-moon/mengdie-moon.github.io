...
$('.waifu-tool .fui-home').click(function (){
    window.location = 'https://mengdie-moon.github.io/';
});
...
$('.waifu-tool .fui-info-circle').click(function (){
    window.open('https://mengdie-moon.github.io/');
});
...
function waifuWelcome(){
    var text;
    var SiteIndexUrl = 'https://mengdie-moon.github.io/';  // 手动指定主页
...
var date_China = new Date();
var date_China_now = date_China.getFullYear();
...
var waifuJson = {
    ...
    "seasons": [
        ...
        {
            "date": "10/01",
            "text": "<span style=\"color:#0099cc;\">国庆节</span>，新中国已经成立{date_China_now-1949}年了呢"
        },
        {
            "date": "11/05-11/12",
